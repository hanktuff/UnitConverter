...
<body data-spy="scroll" data-target=".navbar" data-offset="10">
    ...
    <%-- Contact UnitCandy --%>
    <div id="ContactUnitCandy" class="wrap-container6020">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <form id="formEmail" class="form-horizontal">
                        ...
                        <br />
                        <div id="EmailSuccess" class="col-sm-offset-3 alert alert-success fade in">
                            <a href="#" class="close" aria-label="close" onclick="$('#EmailSuccess').hide();return false;">×</a>
